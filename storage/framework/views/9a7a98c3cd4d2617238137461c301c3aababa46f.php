...
b {
  ...
  text-transform: uppercase;
    ...
    <div id="navMenu" class="diamond">
      ...
      <p><br><a href="<?php echo e(route('home')); ?>" style="color:#000000 ">Home</a></br></p>
    </div>
    <div id="nav1"  class="nav nav1 diamond">
      <div class="rotCorrect"><i class="fa fa-home fa-2x" aria-hidden="true"></i></div>
      <b><br><a href="<?php echo e(route('login')); ?>" style="color:#000000 ">Ingresar</a></br></b>
    </div>
    ...
    <div id="nav2" class="nav nav2 diamond">
      ...
      <b><br><a href="<?php echo e(route('mision')); ?>" style="color:#000000 ">Mision</a></br></b>
    </div>
    <div id="nav3" class="nav nav3 diamond">
      <div class="rotCorrect"><i class="fa fa-calendar fa-2x" aria-hidden="true"></i></div>
      <b><br><a href="<?php echo e(route('plataform')); ?>" style="color:#000000 ">plataforma</a></br></b>
    </div>
...
</html><?php /**PATH C:\Users\User\example-app\resources\views/layaut.blade.php ENDPATH**/ ?>